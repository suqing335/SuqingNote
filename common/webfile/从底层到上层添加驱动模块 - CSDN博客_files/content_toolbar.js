...
// 因为 logo 是SVG 的，所以必须把 iconfont.js 加入到代码里面
  ...
  document.write('<script class="toolbar-s" type="text/javascript" src='+protocol+'//csdnimg.cn/cdn/content-toolbar/iconfont.js?_=123"></script>');
        ...
        <div class="container row center-block ">\
          ...
          <div class="pull-right login-wrap '+loginMark+'">\
            ...
            <li class="toolbar-tracking csdn-tracking-statistics tracking-click" data-mod="popu_369"><a href="#" style="padding:0"></a></li>\
              ...
              <li class="write-bolg-btn csdn-tracking-statistics tracking-click" data-mod="popu_370"><a class="" href="//mp.csdn.net/postedit" target="_blank"><svg class="toolbar-icon" aria-hidden="true"><use xlink:href="#xieboke"></use></svg><span>写博客</span></a></li>\
              <li class="gitChat"><a class="" href="http://gitbook.cn/new/gitchat/activity?utm_source=csdnblog1" target="_blank"><svg class="toolbar-icon" aria-hidden="true"><use xlink:href="#faCHAT"></use></svg><span>发Chat</span></a></li>\
