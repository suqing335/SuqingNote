...
final class WiredAccessoryManager implements WiredAccessoryCallbacks {
    ...
    private static final int BIT_LINEOUT = (1 << 6);
    private static final int BIT_HEADSHANK = (1 << 5);//add by cjf
    private static final int SUPPORTED_HEADSETS = (BIT_HEADSET|BIT_HEADSET_NO_MIC|
                                                   BIT_USB_HEADSET_ANLG|BIT_USB_HEADSET_DGTL|
                                                   BIT_HDMI_AUDIO|BIT_LINEOUT|BIT_HEADSHANK);
    ...
    private void updateLocked(String newName, int newState) {
        ...
        int h2w_headset = headsetState & (BIT_HEADSET | BIT_HEADSET_NO_MIC | BIT_LINEOUT | BIT_HEADSHANK);
        ...
        if (h2w_headset == (BIT_HEADSET | BIT_HEADSET_NO_MIC | BIT_LINEOUT | BIT_HEADSHANK)) {
    ...
    private void setDeviceStateLocked(int headset,
		...
		inDevice = AudioManager.DEVICE_IN_WIRED_HEADPHONE;
	    ...
	    } else if (headset == BIT_HEADSHANK) {//add by cfj
                outDevice = AudioManager.DEVICE_OUT_WIRED_HEADSHANK;
		inDevice = AudioManager.DEVICE_IN_WIRED_HEADSHANK;
            } else {
    ...
    class WiredAccessoryObserver extends UEventObserver {
        ...
        private List<UEventInfo> makeObservedUEventList() {
            ...
            // Monitor h2w
            if (!mUseDevInputEventForAudioJack) {
                uei = new UEventInfo(NAME_H2W, BIT_HEADSET, BIT_HEADSET_NO_MIC, BIT_LINEOUT | BIT_HEADSHANK);
        ...
        private final class UEventInfo {
            ...
            public int computeNewHeadsetState(int headsetState, int switchState) {
                ...
                int setBits = ((switchState == 1) ? mState1Bits :
			      ...
			      ((switchState == 4) ? (mStateNbits & BIT_HEADSHANK):
                              ((switchState == (mStateNbits & ~BIT_HEADSHANK)) ? (mStateNbits & ~BIT_HEADSHANK) : 0))));
