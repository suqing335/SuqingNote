...
public class AudioService extends IAudioService.Stub {
   ...
   /** @hide Maximum volume index values for audio streams */
    ...
    public void setWiredDeviceConnectionState(int device, int state, String name) {
	    if (DEBUG_VOL) Log.d(TAG, "setWiredDeviceConnectionState: device = "+device+", state = "+state+", name = "+name);
        synchronized (mConnectedDevices) {
    ...
    int mBecomingNoisyIntentDevices =
		...
		/*	AudioSystem.DEVICE_OUT_WIRED_HEADPHONE | AudioSystem.DEVICE_OUT_WIRED_HEADSHANK *///delete by cfj
    ...
    private void sendDeviceConnectionIntent(int device, int state, String name)
    {
        ...
        if (device == AudioSystem.DEVICE_OUT_WIRED_HEADSET) {
		  ...
		  || (device == AudioSystem.DEVICE_OUT_SPDIF)) {
            ...
            connType = AudioRoutesInfo.MAIN_HEADSHANK;
            intent.setAction(Intent.ACTION_HEADSET_PLUG);
            intent.putExtra("microphone", 1);
	}
    ...
    private class AudioServiceBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            int inDevice;
            int state;
	    if (DEBUG_VOL) Log.d(TAG, "action = "+action);
