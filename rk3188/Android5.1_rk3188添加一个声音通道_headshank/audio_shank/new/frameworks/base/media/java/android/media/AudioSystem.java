...
public class AudioSystem
{
    ...
    public static final int DEVICE_OUT_SPEAKER_SAFE = 0x800000;
    public static final int DEVICE_OUT_WIRED_HEADSHANK = 0x400000;//add by cfj
    ...
    public static final int DEVICE_IN_WIRED_HEADPHONE = DEVICE_BIT_IN | 0x200000;
    public static final int DEVICE_IN_WIRED_HEADSHANK = DEVICE_BIT_IN | 0x400000;
    ...
    public static final int DEVICE_IN_ALL = (DEVICE_IN_COMMUNICATION |
                                             ...
                                             DEVICE_IN_LOOPBACK |
					     DEVICE_IN_WIRED_HEADPHONE |
					     DEVICE_IN_WIRED_HEADSHANK |
                                             DEVICE_IN_DEFAULT);
    ...
    public static final String DEVICE_OUT_WIRED_HEADSHANK_NAME = "headshank";
    ...
    public static final String DEVICE_IN_WIRED_HEADPHONE_NAME = "headphone";
    public static final String DEVICE_IN_WIRED_HEADSHANK_NAME = "headshank";
	...
	case DEVICE_OUT_WIRED_HEADSHANK:
            return DEVICE_OUT_WIRED_HEADSHANK_NAME;    
    ...
    public static String getInputDeviceName(int device)
    {
        ...
        case DEVICE_IN_WIRED_HEADPHONE:
            return DEVICE_IN_WIRED_HEADPHONE_NAME;
        case DEVICE_IN_WIRED_HEADSHANK:
            return DEVICE_IN_WIRED_HEADSHANK_NAME;	    
