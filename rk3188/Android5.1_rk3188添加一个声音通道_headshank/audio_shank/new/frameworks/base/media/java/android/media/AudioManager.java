...
public class AudioManager {
    ...
    */
    ...
    public boolean isWiredHeadsetOn() {
        if (AudioSystem.getDeviceConnectionState(DEVICE_OUT_WIRED_HEADSET,"")
            ...
            AudioSystem.getDeviceConnectionState(DEVICE_OUT_WIRED_HEADPHONE,"")
                == AudioSystem.DEVICE_STATE_UNAVAILABLE &&
	    AudioSystem.getDeviceConnectionState(DEVICE_OUT_WIRED_HEADSHANK,"")
                == AudioSystem.DEVICE_STATE_UNAVAILABLE){
            return false;
        } else {
            return true;
    ...
    public static final int DEVICE_OUT_WIRED_HEADSHANK = AudioSystem.DEVICE_OUT_WIRED_HEADSHANK;// add by cfj
    /** @hide
    ...
    public static final int DEVICE_IN_WIRED_HEADPHONE =
                                    AudioSystem.DEVICE_IN_WIRED_HEADPHONE;//add by cfj
    public static final int DEVICE_IN_WIRED_HEADSHANK =
                                    AudioSystem.DEVICE_IN_WIRED_HEADSHANK;				    
    /** @hide
     ...
     *            {@link #DEVICE_OUT_WIRED_HEADSHANK},
     *            {@link #DEVICE_OUT_WIRED_HEADPHONE},
