...
const StringToEnum sDeviceNameToEnumTable[] = {
    ...
    STRING_TO_ENUM(AUDIO_DEVICE_OUT_WIRED_HEADSHANK),
                                                             ...
                                                             bool fromCache)
{
    ...
    case STRATEGY_PHONE:
        ...
        default:    // FORCE_NONE
            ...
            if (device) break;
	    device = availableOutputDeviceTypes & AUDIO_DEVICE_OUT_WIRED_HEADSHANK;
            if (device) break;
	...
	if (device2 == AUDIO_DEVICE_NONE) {
            device2 = availableOutputDeviceTypes & AUDIO_DEVICE_OUT_WIRED_HEADSHANK;
        }
        if (device2 == AUDIO_DEVICE_NONE) {
...
audio_devices_t AudioPolicyManager::getDeviceForInputSource(audio_source_t inputSource)
{
    ...
    } else if (availableDeviceTypes & AUDIO_DEVICE_IN_WIRED_HEADPHONE) {
        device = AUDIO_DEVICE_IN_WIRED_HEADPHONE;
    } else if (availableDeviceTypes & AUDIO_DEVICE_IN_WIRED_HEADSHANK) {
