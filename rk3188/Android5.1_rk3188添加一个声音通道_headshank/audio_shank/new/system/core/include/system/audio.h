...
enum {
    ...
    AUDIO_DEVICE_OUT_SPEAKER_SAFE              = 0x800000,
    AUDIO_DEVICE_OUT_WIRED_HEADSHANK	       = 0x400000, //add by cfj
   // PEKALL FMR begin:
    ...
    // PEKALL FMR end
    AUDIO_DEVICE_IN_WIRED_HEADPHONE         = AUDIO_DEVICE_BIT_IN | 0x200000,
    AUDIO_DEVICE_IN_WIRED_HEADSHANK         = AUDIO_DEVICE_BIT_IN | 0x400000,
    ...
    AUDIO_DEVICE_IN_ALL     = (AUDIO_DEVICE_IN_COMMUNICATION |
			       ...
			       AUDIO_DEVICE_IN_WIRED_HEADPHONE |
			       AUDIO_DEVICE_IN_WIRED_HEADSHANK |
