...
public:
	...
	DEVICE_OUT_WIRED_HEADSHANK = 0x4000,
        DEVICE_OUT_DEFAULT = 0x10000,
        DEVICE_OUT_ALL = (DEVICE_OUT_EARPIECE | DEVICE_OUT_SPEAKER | DEVICE_OUT_WIRED_HEADSET |
                DEVICE_OUT_WIRED_HEADPHONE | DEVICE_OUT_BLUETOOTH_SCO | DEVICE_OUT_BLUETOOTH_SCO_HEADSET |
                DEVICE_OUT_BLUETOOTH_SCO_CARKIT | DEVICE_OUT_BLUETOOTH_A2DP | DEVICE_OUT_BLUETOOTH_A2DP_HEADPHONES |
                DEVICE_OUT_BLUETOOTH_A2DP_SPEAKER | DEVICE_OUT_AUX_DIGITAL |
                DEVICE_OUT_ANLG_DOCK_HEADSET | DEVICE_OUT_DGTL_DOCK_HEADSET | DEVICE_OUT_REMOTE_SUBMIX | DEVICE_OUT_WIRED_HEADSHANK |
                DEVICE_OUT_DEFAULT),
	...
	DEVICE_IN_WIRED_HEADPHONE = 0x4000000,
	DEVICE_IN_WIRED_HEADSHANK = 0x8000000,
		...
		DEVICE_IN_WIRED_HEADPHONE | DEVICE_IN_WIRED_HEADSHANK |
                DEVICE_IN_DEFAULT)
    };
