...
const struct config_control rt3224_shank_incall_controls[] = {
    //disable ASRC
    {
        .ctl_name = "ASRC Switch",
        .str_val = "Disable",
...
const struct config_control rt3224_shank_mic_capture_controls[] = {
    {
        .ctl_name = "RECMIXR BST3 Switch",
        .int_val = {off},
    },
...
const struct config_route_table rt3224_config_table = {
 ...
 /*   .shank_incall = {
        .sound_card = 0,
        .devices = DEVICES_0,
        .controls = rt3224_shank_incall_controls,
        .controls_count = sizeof(rt3224_shank_incall_controls) / sizeof(struct config_control),
    },*/
    .headset_ringtone = {
        .sound_card = 0,
        .devices = DEVICES_0,
    ...
    .headshank_mic_capture = {
        .sound_card = 0,
        .devices = DEVICES_0,
        .controls = rt3224_shank_mic_capture_controls,
        .controls_count = sizeof(rt3224_shank_mic_capture_controls) / sizeof(struct config_control),
    },
