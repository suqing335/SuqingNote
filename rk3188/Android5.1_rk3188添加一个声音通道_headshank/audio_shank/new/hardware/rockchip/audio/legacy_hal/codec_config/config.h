...
struct config_route_table
{
    ...
    const struct config_route headshank_normal;
    const struct config_route headshank_incall;
    const struct config_route headshank_ringtone;
    const struct config_route headshank_voip;
    ...
    const struct config_route headphone_mic_capture; 
    const struct config_route headshank_mic_capture;
 ...
 //   const struct config_route shank_mic_capture;
 //   const struct config_route shank_incall;
  //  const struct config_route headphone_mic_capture;
};
