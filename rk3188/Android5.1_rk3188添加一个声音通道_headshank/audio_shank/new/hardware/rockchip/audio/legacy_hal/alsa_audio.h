...
typedef enum _AudioRoute {
    ...
    HEADSET_VOIP_ROUTE,
	HEADSHANK_NORMAL_ROUTE, // 14
    HEADSHANK_INCALL_ROUTE,
    HEADSHANK_RINGTONE_ROUTE,
    HEADSHANK_VOIP_ROUTE,
    ...
    HEADPHONE_MIC_CAPTURE_ROUTE,
    HEADSHANK_MIC_CAPTURE_ROUTE,
