                                                             ...
                                                             bool fromCache)
{
    ...
    case STRATEGY_PHONE:
        ...
        default:    // FORCE_NONE
            ...
            if (device) break;
	    device = mAvailableOutputDevices & AUDIO_DEVICE_OUT_WIRED_HEADSHANK;
            if (device) break;
	...
	if (device2 == AUDIO_DEVICE_NONE) {
            device2 = mAvailableOutputDevices & AUDIO_DEVICE_OUT_WIRED_HEADSHANK;//add by cfj
        }
        if (device2 == AUDIO_DEVICE_NONE) {
    ...
    uint32_t devicePrimary = (AUDIO_DEVICE_OUT_WIRED_HEADSET |
        AUDIO_DEVICE_OUT_WIRED_HEADPHONE |
		 AUDIO_DEVICE_OUT_WIRED_HEADSHANK |
...
audio_devices_t AudioPolicyManagerBase::getDeviceForInputSource(int inputSource)
{
	...
	} else if (mAvailableInputDevices & AUDIO_DEVICE_IN_WIRED_HEADPHONE) {
            device = AUDIO_DEVICE_IN_WIRED_HEADPHONE;
	} else if (mAvailableInputDevices & AUDIO_DEVICE_IN_WIRED_HEADSHANK) {
            device = AUDIO_DEVICE_IN_WIRED_HEADSHANK;
...
AudioPolicyManagerBase::device_category AudioPolicyManagerBase::getDeviceCategory(audio_devices_t device)
{
	...
	case AUDIO_DEVICE_OUT_WIRED_HEADSHANK:
...
const struct StringToEnum sDeviceNameToEnumTable[] = {
    ...
    STRING_TO_ENUM(AUDIO_DEVICE_OUT_WIRED_HEADSHANK),//add by cfj
    ...
    STRING_TO_ENUM(AUDIO_DEVICE_IN_WIRED_HEADPHONE),
    STRING_TO_ENUM(AUDIO_DEVICE_IN_WIRED_HEADSHANK),
};
