...
#include "config.h"
const struct config_control rt3224_speaker_mono_normal_controls[] = {
    //disable ASRC
    {
    ...
    {
        .ctl_name = "Mono MIX OUTVOL L Switch",
        .int_val = {on},
    },
    {
    ...
    {
        .ctl_name = "Mono MIX OUTVOL R Switch",
        .int_val = {on},
    },
...
const struct config_control rt3224_speaker_mono_incall_controls[] = {
    //disable ASRC
    {
        .ctl_name = "ASRC Switch",
        .str_val = "Disable",
...
//用于控制LOUTL LOUTR 这个口连接到 3G modem 音频输入端
    {
        .ctl_name = "OUT Playback Switch",
        .int_val = {on, on},
    },
};
const struct config_control rt3224_speaker_mono_ringtone_controls[] = {	
    //disable ASRC
    {
        .ctl_name = "ASRC Switch",
        .str_val = "Disable",
...
const struct config_control rt3224_speaker_mono_voip_controls[] = {
    //disable ASRC
    {
        .ctl_name = "ASRC Switch",
        .str_val = "Disable",
...
const struct config_control rt3224_headshank_normal_controls[] = {
    //disable ASRC
    {
        .ctl_name = "ASRC Switch",
        .str_val = "Disable",
...
const struct config_control rt3224_headshank_incall_controls[] = {
    //disable ASRC
    {
        .ctl_name = "ASRC Switch",
        .str_val = "Disable",
...
const struct config_control rt3224_headshank_ringtone_controls[] = {
    //disable ASRC
    {
        .ctl_name = "ASRC Switch",
        .str_val = "Disable",
...
const struct config_control rt3224_headshank_voip_controls[] = {
    //disable ASRC
    {
        .ctl_name = "ASRC Switch",
        .str_val = "Disable",
...
const struct config_control rt3224_headphone_mic_capture_controls[] = {
    {
        .ctl_name = "RECMIXR BST3 Switch",
        .int_val = {off},
    },
...
const struct config_control rt3224_headshank_mic_capture_controls[] = {
    {
        .ctl_name = "RECMIXR BST3 Switch",
        .int_val = {off},
    },
...
const struct config_route_table rt3224_config_table = {
    ...
    .speaker_normal = {
        .sound_card = 0,
        .devices = DEVICES_0,
	.controls = rt3224_speaker_mono_normal_controls,
        .controls_count = sizeof(rt3224_speaker_mono_normal_controls) / sizeof(struct config_control),
    ...
    .speaker_incall = {
        .sound_card = 0,
        .devices = DEVICES_0,
	.controls = rt3224_speaker_mono_incall_controls,
        .controls_count = sizeof(rt3224_speaker_mono_incall_controls) / sizeof(struct config_control),
    ...
    .speaker_ringtone = {
        .sound_card = 0,
        .devices = DEVICES_0,
	.controls = rt3224_speaker_mono_ringtone_controls,
        .controls_count = sizeof(rt3224_speaker_mono_ringtone_controls) / sizeof(struct config_control),
    ...
    .speaker_voip = {
        .sound_card = 0,
        .devices = DEVICES_0,
	.controls = rt3224_speaker_mono_voip_controls,
        .controls_count = sizeof(rt3224_speaker_mono_voip_controls) / sizeof(struct config_control),
    ...
    .headshank_normal = {
        .sound_card = 0,
        .devices = DEVICES_0,
        .controls = rt3224_headshank_normal_controls,
        .controls_count = sizeof(rt3224_headshank_normal_controls) / sizeof(struct config_control),
    },
    .headshank_incall = {
        .sound_card = 0,
        .devices = DEVICES_0,
        .controls = rt3224_headshank_incall_controls,
        .controls_count = sizeof(rt3224_headshank_incall_controls) / sizeof(struct config_control),
    },
    .headshank_ringtone = {
        .sound_card = 0,
        .devices = DEVICES_0,
        .controls = rt3224_headshank_ringtone_controls,
        .controls_count = sizeof(rt3224_headshank_ringtone_controls) / sizeof(struct config_control),
    },
    .headshank_voip = {
        .sound_card = 0,
        .devices = DEVICES_0,
        .controls = rt3224_headshank_voip_controls,
        .controls_count = sizeof(rt3224_headshank_voip_controls) / sizeof(struct config_control),
    },
    ...
    .headshank_mic_capture = {
        .sound_card = 0,
        .devices = DEVICES_0,
        .controls = rt3224_headshank_mic_capture_controls,
        .controls_count = sizeof(rt3224_headshank_mic_capture_controls) / sizeof(struct config_control),
    },
    .headphone_mic_capture = {
        .sound_card = 0,
        .devices = DEVICES_0,
        .controls = rt3224_headphone_mic_capture_controls,
        .controls_count = sizeof(rt3224_headphone_mic_capture_controls) / sizeof(struct config_control),
    },
