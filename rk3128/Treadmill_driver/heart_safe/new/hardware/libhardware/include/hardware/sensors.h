...
#define SENSOR_TYPE_HEARTRATE					(26)
#define SENSOR_STRING_TYPE_HEARTRATE				"android.sensor.heartrate"
#define SENSOR_TYPE_SAFELOCK					(27)
#define SENSOR_STRING_TYPE_SAFELOCK				"android.sensor.safelock"
/**
