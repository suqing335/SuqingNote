...
sensors_poll_context_t::sensors_poll_context_t()
{
	...
	mSensors[safelock] = new SafelockSensor();
    mPollFds[safelock].fd = mSensors[safelock]->getFd();
    mPollFds[safelock].events = POLLIN;
    mPollFds[safelock].revents = 0;
