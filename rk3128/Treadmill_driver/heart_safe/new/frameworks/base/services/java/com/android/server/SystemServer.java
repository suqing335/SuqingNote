...
//end blb
		...
		/**add by cfj***/
		try {
			Slog.i(TAG, "starting DirectService");
			direct = new DirectService(context);
			ServiceManager.addService(Context.DIRECT_SERVICE, direct);

		} catch (Throwable e) {
			reportWtf("Failure starting DirectService", e);
		}
