...
public final class Sensor {
    ...
    /**
     * A constant describing a heartrate sensor type.
     * <p>See {@link android.hardware.SensorEvent#values SensorEvent.values}
     * for more details.
     */
    public static final int TYPE_HEARTRATE = 26;
     ...
     * @see #TYPE_HEARTRATE
     */
    public static final String STRING_TYPE_HEARTRATE = "android.sensor.heartrate";
	/**
     * A constant describing a safelock sensor type.
     * <p>See {@link android.hardware.SensorEvent#values SensorEvent.values}
     * for more details.
     */
    public static final int TYPE_SAFELOCK = 27;

    /**
     * A constant string describing a safelock sensor type.
     *
     * @see #TYPE_SAFELOCK
     */
    public static final String STRING_TYPE_SAFELOCK = "android.sensor.safelock";
    ...
    private static final int[] sSensorReportingModes = {
	    ...
	    3, // SENSOR_TYPE_HEARTRATE
	    3, // SENSOR_TYPE_SAFELOCK
    };
