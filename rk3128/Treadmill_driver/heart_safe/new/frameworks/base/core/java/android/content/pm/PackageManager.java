...
public abstract class PackageManager {
     ...
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_SENSOR_HEARTRATE = "android.hardware.sensor.heart.rate";
     ...
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_SENSOR_SAFELOCK = "android.hardware.sensor.safelock";
